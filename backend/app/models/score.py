"""Score model — per-block normalized scoring for an assessment."""
...
class Score(Base, TimestampMixin):
    ...
    max_score: Mapped[float] = mapped_column(Numeric(6, 2), nullable=False, default=0)
    percentage: Mapped[float] = mapped_column(Numeric(6, 3), nullable=False, default=0)
