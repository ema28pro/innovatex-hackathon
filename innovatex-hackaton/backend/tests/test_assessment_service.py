...
# Ensure scoring_service is importable for patching even if Agent D hasn't
# shipped it yet. If the real module exists, this is a no-op.
import sys as _sys
import types as _types
try:  # noqa: SIM105
    import app.services.scoring_service  # noqa: F401
except Exception:  # pragma: no cover - environment-dependent
    _stub = _types.ModuleType("app.services.scoring_service")
    _stub.compute_and_persist = lambda db, assessment: 0.0
    _sys.modules["app.services.scoring_service"] = _stub
    import app.services as _svc_pkg
    _svc_pkg.scoring_service = _stub
